...
export class HighContentionAllocator {
  ...
  /**
   * @param {DbAny | TxnAny} dbOrTxn
   * @returns {Promise<{ counters: unknown; recent: unknown; }>}
   */
  // For debugging.
...
class Node {
  ...
  constructor(subspace, path, targetPath) {
    ...
    /** @type {Buffer | null} */
    this.layer = null // Filled in lazily. Careful - this will most often be empty.
  }
   ...
   * @param {TxnAny} [txn]
   * @returns {Promise<null | Directory<any, any, any, any>>}
   */
