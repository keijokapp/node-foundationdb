...
export default class Subspace {
  /**
   * @param {string | Buffer | null} rawPrefix
   * @param {import('foundationdb').Transformer<KeyIn, KeyOut>} [keyXf]
   * @param {import('foundationdb').Transformer<ValIn, ValOut>} [valueXf]
   */
  constructor(rawPrefix, keyXf, valueXf) {
    ...
    /** @type {import('foundationdb').Transformer<KeyIn, KeyOut>} */
    this.keyXf = keyXf || /** @type {import('foundationdb').Transformer<any, any>} */(defaultTransformer)
    /** @type {import('foundationdb').Transformer<ValIn, ValOut>} */
    this.valueXf = valueXf || /** @type {import('foundationdb').Transformer<any, any>} */(defaultTransformer)
   ...
   * @overload
   * @param {undefined} [keyXf]
   * @returns {Subspace<import('foundationdb').NativeValue, Buffer, ValIn, ValOut>}
   */
  /**
   * @template CKI, CKO
   * @overload
   ...
   * @param {import('foundationdb').Transformer<CKI, CKO>} [keyXf]
   * @returns {(
   *   | Subspace<import('foundationdb').NativeValue, Buffer, ValIn, ValOut>
   *   | Subspace<CKI, CKO, ValIn, ValOut>
   * )}
   */
  /**
   ...
   * @overload
   * @param {undefined} [keyXf]
   * @returns {Subspace<KeyIn, KeyOut, import('foundationdb').NativeValue, Buffer>}
   */
  /**
   * @template CVI, CVO
   * @overload
   ...
   * @param {import('foundationdb').Transformer<CVI, CVO>} [valueXf]
   * @returns {(
   *   | Subspace<KeyIn, KeyOut, import('foundationdb').NativeValue, Buffer>
   *   | Subspace<KeyIn, KeyOut, CVI, CVO>
   * )}
   */
  /**
  ...
  /**
   * @param {KeyIn} key
   * @returns {import('foundationdb').NativeValue}
   */
  packKey(key) {
  ...
  /**
   * @param {KeyIn} key
   * @returns {import('foundationdb').UnboundStamp}
   */
   ...
   * @returns {{begin: import('foundationdb').NativeValue, end: import('foundationdb').NativeValue}} Encoded range as a `{ begin, end }` record.
   */
  packRange(start, end) {
    return {
...
export const root = new Subspace(null, defaultTransformer, defaultTransformer)

/**
 * @template KI, KO, VI, VO
 * @param {any} obj
 * @returns {obj is import('foundationdb').GetSubspace<KI, KO, VI, VO>}
 */
