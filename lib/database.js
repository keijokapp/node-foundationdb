...
/**
 * @template [KeyIn=import('foundationdb').NativeValue]
 * @template [KeyOut=Buffer]
 * @template [ValIn=import('foundationdb').NativeValue]
 * @template [ValOut=Buffer]
 */
export default class Database {
  /**
   * @param {import('foundationdb').NativeDatabase} db
   * @param {Subspace<KeyIn, KeyOut, ValIn, ValOut>} subspace
   */
  constructor(db, subspace) {
    /** @type {import('foundationdb').NativeDatabase} */
    this._db = db
  ...
  /**
   * @param {import('foundationdb').DatabaseOptions} opts
   */
   ...
   * @template CKI, CKO
   * @overload
   * @param {KeyIn | null | undefined} prefix
   * @param {import('foundationdb').Transformer<CKI, CKO>} keyXf
   * @param {undefined} [valueXf]
   ...
   * @param {KeyIn | null | undefined} prefix
   * @param {undefined} keyXf
   * @param {import('foundationdb').Transformer<CVI, CVO>} valueXf
   ...
   * @overload
   * @param {KeyIn | null | undefined} prefix
   * @param {import('foundationdb').Transformer<CKI, CKO> | undefined} keyXf
   * @param {import('foundationdb').Transformer<CVI, CVO>} valueXf
   * @returns {(
   *   | Database<KeyIn, KeyOut, CVI, CVO>
   ...
   * @param {import('foundationdb').GetSubspace<CKI, CKO, CVI, CVO> | KeyIn | null} [prefixOrSubspace]
   * @param {import('foundationdb').Transformer<unknown, unknown>} [keyXf]
   * @param {import('foundationdb').Transformer<unknown, unknown>} [valueXf]
   ...
   * @overload
   * @param {undefined} [keyXf]
   * @returns {Database<import('foundationdb').NativeValue, Buffer, ValIn, ValOut>}
   */
  /**
   * @template CKI, CKO
   * @overload
   ...
   * @param {import('foundationdb').Transformer<CKI, CKO>} [keyXf]
   * @returns {(
   *   | Database<import('foundationdb').NativeValue, Buffer, ValIn, ValOut>
   *   | Database<CKI, CKO, ValIn, ValOut>
   * )}
   */
  /**
   ...
   * @overload
   * @param {undefined} [keyXf]
   * @returns {Database<KeyIn, KeyOut, import('foundationdb').NativeValue, Buffer>}
   */
  /**
   * @template CVI, CVO
   * @overload
   ...
   * @param {import('foundationdb').Transformer<CVI, CVO>} [valueXf]
   * @returns {(
   *   | Database<KeyIn, KeyOut, import('foundationdb').NativeValue, Buffer>
   *   | Database<KeyIn, KeyOut, CVI, CVO>
   * )}
   */
  /**
   ...
   * @param {import('foundationdb').TransactionOptions} [opts]
   * @returns {Promise<T>}
   */
  ...
  /**
   * @param {KeyIn | import('foundationdb').KeySelector<KeyIn>} selector
  ...
  /**
   * @param {KeyIn} key
   * @returns {Promise<import('foundationdb').WatchWithValue<ValOut>>}
   */
  getAndWatch(key) {
    return this.doTransaction(async tn => {
      const value = await tn.get(key)
      const watch = /** @type {import('foundationdb').WatchWithValue<ValOut>} */(tn.watch(key))
      watch.value = value
      return watch
    })
  }
   ...
   * @param {KeyIn} key
   * @param {ValIn} value
   * @returns {Promise<import('foundationdb').Watch>}
   */
