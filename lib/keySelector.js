 ...
 * @param {number} offset
 * @returns {import('foundationdb').KeySelector<Key>}
 */
...
/**
 * @template Key
 * @param {import('foundationdb').KeySelector<Key>} sel
 ...
 * @template Key
 * @param {any} val
 * @returns {val is import('foundationdb').KeySelector<Key>}
 */
...
/**
 * @template Key
 * @param {Key | import('foundationdb').KeySelector<Key>} valOrKS
 * @returns {import('foundationdb').KeySelector<Key>}
 */
const from = (valOrKS) => (
 ...
 * @template Key
 * @param {import('foundationdb').KeySelector<Key>} sel
 * @param {import('foundationdb').Transformer<Key, any>} xf
 * @returns {import('foundationdb').KeySelector<import('foundationdb').NativeValue>}
 */
