/**
 * @import { KeySelector, NativeValue, Transformer } from './types.js'
 */
 ...
 */
const isKeySelector = val => typeof val === 'object' && val != null && val._isKeySelector
 ...
 * @template Key
 * @param {KeySelector<Key>} sel
 * @param {Transformer<Key, any>} xf
 * @returns {KeySelector<NativeValue>}
 */
