...
export class Database<KeyIn = NativeValue, KeyOut = Buffer, ValIn = NativeValue, ValOut = Buffer> {
    _db: NativeDatabase;
    subspace: Subspace<KeyIn, KeyOut, ValIn, ValOut>;
    constructor(db: NativeDatabase, subspace: Subspace<KeyIn, KeyOut, ValIn, ValOut>);
...
export interface NativeTransaction {
    ...
    getRange(start: NativeValue, beginOrEq: boolean, beginOffset: number, end: NativeValue, endOrEq: boolean, endOffset: number, limit: number, target_bytes: number, mode: StreamingMode, iter: number, isSnapshot: boolean, reverse: boolean): Promise<KVList<Buffer, Buffer>>;
...
export class Subspace<KeyIn = NativeValue, KeyOut = Buffer, ValIn = NativeValue, ValOut = Buffer> {
    prefix: Buffer;
 ...
 */
export class Transaction<KeyIn = NativeValue, KeyOut = Buffer, ValIn = NativeValue, ValOut = Buffer> {
    private _tn;
    isSnapshot: boolean;
    subspace: Subspace<KeyIn, KeyOut, ValIn, ValOut>;
    private _ctx;
...
export type NetworkOptions = {
    local_address?: undefined | string;
    cluster_file?: undefined | string;
    trace_enable?: undefined | string;
    trace_roll_size?: undefined | number;
    trace_max_logs_size?: undefined | number;
    trace_log_group?: undefined | string;
    trace_format?: undefined | string;
    trace_clock_source?: undefined | string;
    trace_file_identifier?: undefined | string;
    trace_share_among_client_threads?: undefined | true;
    trace_partial_file_suffix?: undefined | string;
    knob?: undefined | string;
    TLS_plugin?: undefined | string;
    TLS_cert_bytes?: undefined | Buffer;
    TLS_cert_path?: undefined | string;
    TLS_key_bytes?: undefined | Buffer;
    TLS_key_path?: undefined | string;
    TLS_verify_peers?: undefined | Buffer;
    Buggify_enable?: undefined | true;
    Buggify_disable?: undefined | true;
    Buggify_section_activated_probability?: undefined | number;
    Buggify_section_fired_probability?: undefined | number;
    TLS_ca_bytes?: undefined | Buffer;
    TLS_ca_path?: undefined | string;
    TLS_password?: undefined | string;
    disable_multi_version_client_api?: undefined | true;
    callbacks_on_external_threads?: undefined | true;
    external_client_library?: undefined | string;
    external_client_directory?: undefined | string;
    disable_local_client?: undefined | true;
    client_threads_per_version?: undefined | number;
    future_version_client_library?: undefined | string;
    disable_client_statistics_logging?: undefined | true;
    enable_slow_task_profiling?: undefined | true;
    ...
    client_buggify_section_activated_probability?: undefined | number;
    client_buggify_section_fired_probability?: undefined | number;
    distributed_client_tracer?: undefined | string;
    client_tmp_dir?: undefined | string;
    supported_client_versions?: undefined | string;
    external_client?: undefined | true;
    external_client_transport_id?: undefined | number;
};
...
export type DatabaseOptions = {
    location_cache_size?: undefined | number;
    max_watches?: undefined | number;
    machine_id?: undefined | string;
    datacenter_id?: undefined | string;
    snapshot_ryw_enable?: undefined | true;
    snapshot_ryw_disable?: undefined | true;
    transaction_logging_max_field_length?: undefined | number;
    transaction_timeout?: undefined | number;
    transaction_retry_limit?: undefined | number;
    transaction_max_retry_delay?: undefined | number;
    transaction_size_limit?: undefined | number;
...
export type TransactionOptions = {
    ...
    read_ahead_disable?: undefined | true;
    durability_datacenter?: undefined | true;
    durability_risky?: undefined | true;
    durability_dev_null_is_web_scale?: undefined | true;
    ...
    debug_retry_logging?: undefined | string;
    transaction_logging_enable?: undefined | string;
    debug_transaction_identifier?: undefined | string;
    log_transaction?: undefined | true;
    transaction_logging_max_field_length?: undefined | number;
    server_request_tracing?: undefined | true;
    timeout?: undefined | number;
    retry_limit?: undefined | number;
    max_retry_delay?: undefined | number;
    size_limit?: undefined | number;
    idempotency_id?: undefined | string;
    ...
    auto_throttle_tag?: undefined | string;
    span_parent?: undefined | Buffer;
    ...
    authorization_token?: undefined | string;
};
