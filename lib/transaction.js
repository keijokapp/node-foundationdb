...
import {strInc, strNext, asBuf} from './util.js'
 ...
 * @private
 * @template T
 * @typedef {{item: T, transformer: import('./transformer.js').Transformer<T, any>, code: Buffer | null}} BakeItem
 */
/**
 * @private
 * @typedef {{
...
export default class Transaction {
   ...
   * @param {import('./keySelector.js').KeySelector<import('./native.js').NativeValue> | null} end
   * @param {number} limit
   ...
   * @param {import('./keySelector.js').KeySelector<KeyIn> | null} end
   * @param {number} limit
   * @param {number} targetBytes
   * @param {StreamingMode} streamingMode
   * @param {number} iter
