...
import {strInc, strNext, asBuf} from './util'

const doNothing = () => {}

/**
 * @template T
 * @typedef {{item: T, transformer: import('foundationdb').Transformer<T, any>, code: Buffer | null}} BakeItem
 */
/**
 * @typedef {{
 *   nextCode: number,
 ...
 *
 * @template [KeyIn=import('foundationdb').NativeValue] The type for keys passed by the user into functions (eg `get(k:
 ...
 * be Buffer.
 * @template [ValIn=import('foundationdb').NativeValue] The type of values passed into transaction functions, like
...
export default class Transaction {
   ...
   *
   * @internal
   * @param {import('foundationdb').NativeTransaction} tn
  ...
  constructor(
    ...
    /**
     * @private
     * @type {import('foundationdb').NativeTransaction}
     */
    this._tn = tn
   ...
   *
   * @param {import('foundationdb').TransactionOptionCode} opt
   ...
   * @param {import('foundationdb').GetSubspace<CKI, CKO, CVI, CVO>} hasSubspace
   ...
   *
   * @param {import('foundationdb').KeySelector<KeyIn> | KeyIn} _sel
  ...
  /**
   * @param {import('foundationdb').KeySelector<import('foundationdb').NativeValue>} start
   * @param {import('foundationdb').KeySelector<import('foundationdb').NativeValue> | null} end
   * @param {number} limit
   * @param {number} targetBytes
   * @param {import('foundationdb').StreamingMode} streamingMode
   * @param {number} iter
   * @param {boolean} reverse
   * @returns {Promise<import('foundationdb').KVList<Buffer, Buffer>>}
   */
  ...
  /**
   * @param {import('foundationdb').KeySelector<KeyIn>} start
   * @param {import('foundationdb').KeySelector<KeyIn> | null} end
   * @param {number} limit
   * @param {number} targetBytes
   * @param {import('foundationdb').StreamingMode} streamingMode
   * @param {number} iter
   * @param {boolean} reverse
   * @returns {Promise<import('foundationdb').KVList<KeyOut, ValOut>>}
   */
  ...
  /**
   * @param {import('foundationdb').KeySelector<import('foundationdb').NativeValue>} start
   * @param {import('foundationdb').KeySelector<import('foundationdb').NativeValue>} end
   * @param {import('foundationdb').RangeOptions} opts
   */
   ...
   *
   * @param {KeyIn | import('foundationdb').KeySelector<undefined | KeyIn>} [start]
   * @param {KeyIn | import('foundationdb').KeySelector<undefined | KeyIn>} [end]
   * @param {import('foundationdb').RangeOptions} [opts]
   */
   ...
   *
   * @param {KeyIn | import('foundationdb').KeySelector<KeyIn>} prefix
   * @param {import('foundationdb').RangeOptions} [opts]
   */
  ...
  async getRangeAll(start, end, opts) {
    /** @type {import('foundationdb').RangeOptions} */
  ...
  /**
   * @param {KeyIn} key
   * @param {import('foundationdb').WatchOptions} [opts]
   * @returns {import('foundationdb').Watch}
   */
  watch(key, opts) {
    this._assertValid();
  ...
  /**
   * @param {import('foundationdb').Version} v 8-byte version
   */
  setReadVersion(v) {
    this._assertValid();
   ...
   *
   * @returns {Promise<import('foundationdb').Version>}
   */
  getReadVersion() {
    this._assertValid();
  ...
  /**
   * @returns {import('foundationdb').Version}
   */
  getCommittedVersion() {
    this._assertValid();
  ...
  /**
   * @param {import('foundationdb').MutationType} opType
   * @param {import('foundationdb').NativeValue} key
   * @param {import('foundationdb').NativeValue} oper
   */
  ...
  /**
   * @private
   * @param {import('foundationdb').UnboundStamp} into
   * @returns {Buffer | null}
   */
  _bakeCode(into) {
   ...
   * @private
   * @param {T} item
   * @param {import('foundationdb').Transformer<T, any>} transformer
   * @param {Buffer | null} code
   */
   ...
   *
   * @param {KeyIn} key
   * @returns {Promise<{stamp: Buffer, value?: ValOut} | null>}
   */
